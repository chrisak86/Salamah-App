          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                Hospitals hospital = controller.hospitals[index];
                return Container(
                  padding: const EdgeInsets.symmetric(vertical: 16.0),
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Center(
                          child: Text(hospital.location.toString()),
                        ),
                      ),
                      Expanded(
                        child: Center(
                          child: GestureDetector(
                            onTap: () {
                              ...
                              controller.updateHospital(hospital);
                            },
                            child: Container(
                              width: 70,
                              height: 30,
                              decoration: BoxDecoration(
                                ...
                                color: hospital.status == true ? AppColors.primary : Colors.grey,
                              ),
                              child: Stack(
                                children: [
                                  Align(
                                    alignment: hospital.status == true ? Alignment.centerRight : Alignment.centerLeft,
                                    child: Padding(
                                  ...
                                  Padding(
                                    ...
                                    child: Align(
                                      alignment: hospital.status == true ?  Alignment.centerLeft : Alignment.centerRight,
                                      child: Text(
                                        hospital.status==true ? "Online" : "Offline",
